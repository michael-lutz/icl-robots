...
class HumanoidWalkingTask(ksim.PPOTask[Config], Generic[Config]):
    ...
    def get_mujoco_model(self) -> tuple[mujoco.MjModel, dict[str, JointMetadataOutput]]:
        ...
        mjcf_path = (Path(__file__).parent / "robots" / "default_humanoid.mjcf").resolve().as_posix()
    ...
    def get_initial_model_carry(self, rng: PRNGKeyArray) -> None:
        ...
        Returns:
            None as no carry state is needed.
        """
        return None
    ...
    def get_ppo_variables(
        ...
        Returns:
            A tuple of PPO variables and None for the carry state.
        """
...
if __name__ == "__main__":
    ...
    #   python -m iclrobot.dh_walking.walking
    # To visualize the environment, use the following command:
    #   python -m iclrobot.dh_walking.walking run_environment=True
    # On MacOS or other devices with less memory, you can change the number
    # of environments and batch size to reduce memory usage. Here's an example
    # from the command line:
    #   python -m iclrobot.dh_walking.walking num_envs=8 rollouts_per_batch=4
